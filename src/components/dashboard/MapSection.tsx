  ...
  return (
    <Card className="h-full">
      ...
      <CardContent className="flex flex-col items-center justify-center">
        <div className="w-full lg:w-[90%] h-64 lg:h-96 bg-gray-200 rounded-2xl mb-4">
          <iframe
        ...
        <div className="flex flex-col space-y-4 w-full justify-center items-center">
          <Button
            variant="secondary"
            className="w-full lg:w-[90%] h-12 rounded-full border-[#E5E5E5] border-2"
          >
            Way to Pickup
          </Button>
          <Button
          ...
          <Button className="w-full lg:w-[90%] h-12 rounded-full">Delivered</Button>
        </div>
      </CardContent>
    </Card>
  );
