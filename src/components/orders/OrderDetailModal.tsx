      ...
      <DialogContent className="lg:max-w-[450px] max-w-[400px] rounded-xl">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="text-lg text-[#050505] font-bold">Customer Name</div>
              <div className="text-[#808080] text-sm">{order.customerName}</div>
            </div>
            <div>
              <div className="text-lg text-[#050505] font-bold flex justify-end">Customer Number</div>
              <div className="text-[#808080] text-sm flex justify-end">{order.customerNumber}</div>
            </div>
            <div>
            ...
            <div>
              <div className="text-lg text-[#050505] font-bold flex justify-end">Pickup Time</div>
              <div className="text-[#808080] text-sm flex justify-end">{order.pickupTime || "Not available"}</div>
            </div>
            <div>
            ...
            <div>
              <div className="text-lg text-[#050505] font-bold flex justify-end">Delivery Time</div>
              <div className="text-[#808080] text-sm flex justify-end">{order.deliveryTime || "Not available"}</div>
            </div>
          </div>
